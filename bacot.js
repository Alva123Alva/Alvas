...
say(`SC INI BUATAN ALWAYSAQIOOO , DI LARANG RECODE/RENAME SESUKA HATI`, {
  ...
  gradient: [randomcolor, randomcolor]
    ...
    const phoneNumber = await question(`👾masukin no wangcap lu awalnya 6282335830486(jangan 08) \n 🚩 6282335830486 : `);
...
await sleep(30000)
Alwaysaqioo.sendMessage(`6282335830486@s.whatsapp.net`, { text: `❗?BOT ALWAYSAQIO BERHASIL CONNECT️`})
            }
